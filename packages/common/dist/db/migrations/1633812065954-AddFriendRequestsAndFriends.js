...
exports.AddFriendRequestsAndFriends1633812065954 = void 0;
class AddFriendRequestsAndFriends1633812065954 {
    constructor() {
        this.name = 'AddFriendRequestsAndFriends1633812065954';
    }
    async up(queryRunner) {
        await queryRunner.query(`CREATE TABLE "friend_request" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "receiverId" integer, "senderId" integer, CONSTRAINT "PK_4c9d23ff394888750cf66cac17c" PRIMARY KEY ("id"))`);
...
exports.AddFriendRequestsAndFriends1633812065954 = AddFriendRequestsAndFriends1633812065954;
//# sourceMappingURL=1633812065954-AddFriendRequestsAndFriends.js.map